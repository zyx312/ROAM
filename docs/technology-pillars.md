...
- **YD/T 4778-2024** 《基于 5G 的远程遥控驾驶信息交互系统 总体技术要求》（CCSA，2024-10-01 实施）
- **YD/T 4779-2024** 《城市运营车紧急接管技术要求》（CCSA）
- **YD/T 4780-2024** 《自动驾驶出租车云端控制技术要求》（CCSA）
- *注：中国汽车工程学会（CSAE）迄今尚无专门的 L4 远程驾驶/远程运营技术要求团体标准，这一空白是 ROAM 标准提案的核心机会 —— 详见 [`standards/`](../standards/) 目录。*
